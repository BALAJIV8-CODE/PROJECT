...
public class DigitalTime {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					DigitalTime window = new DigitalTime();
	...
	private void initialize() {
		...
		try {
			 f = Font.createFont(Font.TRUETYPE_FONT, DigitalTime.class.getResourceAsStream("/Open24DisplaySt.ttf"));
		...
		Button button_1 = new Button("MIN");
		button_1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				// MINIMUZE BUTTON FROM SOFTWARE
				frame.setExtendedState(JFrame.ICONIFIED);
			}
		});
		button_1.setBackground(new Color(238, 238, 236));
		button_1.setBounds(44, 241, 70, 22);
		panel.add(button_1);
		
		
		Button button_2 = new Button("MAX");
		button_1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				// MINIMUZE BUTTON FROM SOFTWARE
		...
		button_2.setBackground(new Color(238, 238, 236));
		button_2.setBounds(434, 241, 70, 22);
		panel.add(button_2);
